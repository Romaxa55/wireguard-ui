![](https://github.com/romaxa55/wireguard-ui/workflows/wireguard-ui%20build%20release/badge.svg)
...
| `WG_CONF_TEMPLATE`          | The custom `wg.conf` config file template. Please refer to our [default template](https://github.com/romaxa55/wireguard-ui/blob/master/templates/wg.conf) | N/A                                |
...
:information_source: A container image is avaialble on [Docker Hub](https://hub.docker.com/r/romaxa55/wireguard-ui) which you can pull and use 
```
docker pull romaxa55/wireguard-ui
````
...
MIT. See [LICENSE](https://github.com/romaxa55/wireguard-ui/blob/master/LICENSE).
